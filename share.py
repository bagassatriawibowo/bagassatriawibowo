...
right_col.markdown(f"Negara dengan total produksi terbanyak yakni : {negara_negara[max_total_produksi_idx]} ({max_total_produksi}) dan pada tahun {tahun} produksi terbanyaknya yakni :{negara_negara[max_produksi_idx]} ({max_produksi})")
