...
right_col.markdown(f"**Negara dengan total produksi terbanyak adalah {negara_negara2}: {cntry[max_produksi_idx]} ({max_produksi}) dengan produksi terbanyak pada tahun {tahun}:**\n {(sum_produksi)}")
