...
right_col.markdown(f"Negara dengan total produksi terbanyak adalah : {negara_negara2[min_total_produksi_idx]} ({min_total_produksi}) dan pada tahun {tahun} produksi terbanyaknya yakni sebesar:{negara_negara2[min_produksi_idx]} ({min_produksi})")
