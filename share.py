...
right_col.markdown(f"Negara dengan total produksi terbanyak adalah : {negara_negara2[max_total_produksi_idx]} ({max_total_produksi}) dan pada tahun {tahun} produksi terbanyaknya yakni sebesar:{negara[max_produksi_idx]} ({max_produksi})")
